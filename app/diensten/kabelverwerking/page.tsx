...
export const metadata: Metadata = {
  title: 'Kabelverwerking & Kabelshredder Venlo | RJMK',
  description: 'RJMK beschikt over een eigen kabelshredder voor het efficiënt en milieuvriendelijk verwerken van koper- en aluminiumkabels. Beste prijzen in Venlo.',
};
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-8 text-slate-600 leading-relaxed">
              <div className="glass-card p-8 rounded-xl">
                ...
                <p className="mb-4">
                  Oude kabels bevatten waardevolle metalen zoals koper en aluminium, maar het scheiden van het metaal en de kunststof isolatie is een specialistisch proces. Bij RJMK beschikken wij over een eigen, geavanceerde kabelshredder op onze locatie in Venlo.
                </p>
                <p className="mb-4">
